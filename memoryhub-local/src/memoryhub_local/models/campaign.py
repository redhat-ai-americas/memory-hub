...
Dialect-portable version: uses PortableUUID and IntervalSeconds instead of
PostgreSQL-specific UUID and Interval types.
"""
...
from memoryhub_local.models.dialect import IntervalSeconds, PortableUUID
...
class Campaign(TimestampMixin, Base):
    ...
    default_ttl: Mapped[int | None] = mapped_column(IntervalSeconds(), nullable=True)
