...
- [`planning/operator.md`](https://github.com/redhat-ai-americas/memory-hub-scratchpad/blob/main/planning/operator.md) -- the future operator will adopt this contract
