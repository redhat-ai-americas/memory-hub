...
| ~14k lines of new docs sit uncommitted at session end | Fix now | `docs/identity-model/` and `docs/scenarios/` are both untracked. Need to decide whether to commit before another session touches the repo. |
...
- [ ] Decide whether to commit `docs/identity-model/` and `docs/scenarios/` now
